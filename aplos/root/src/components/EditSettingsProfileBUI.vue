    ...
    <div class="basic-info-container">
      ...
      <form class="forms-container">
        ...
        <div class="info-form">
            ...
            <input type="text" name="phone"  v-model="data.phone" :disabled="loading" />
            <label for="pass">New Password</label>
            <input type="password" name="pass"  v-model="data.pass" :disabled="loading" autocomplete  />
            <label for="pass">Confirm New Password</label>
            <input type="password" name="cpass" v-model="data.cpass" :disabled="loading" autocomplete />
            <button type="submit" @click="loading = !loading" v-btnload="loading" value="SAVE" />
        </div>
      </form>
    </div>
</template>
...
export default {
  ...
  async created(){
    this.odata = await this.$tuos.auth.userMe()
